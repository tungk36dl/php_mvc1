...
<tr>
    <th>ID</th>
    <th> <a href="/admin/users?sort_by=username&sort_type=<?php echo $sort_type; echo $str1 ?? '';?>">Username </a></th>
    <th> <a href="/admin/users?sort_by=email&sort_type=<?php echo $sort_type; echo $str1 ?? ''?>"> 
    Email </a></th>
    <th>Admin</th>
